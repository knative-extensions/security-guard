...
| -------- | ------- | --------|
| SERVICE_NAME | Unique name given to the service  - used also as teh guardian name | (required) |
...
| GUARD_URL | teh url of the guard-service | "http://guard-service.knative-serving" |
