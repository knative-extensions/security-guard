...
kubectl apply -f https://github.com/knative-extensions/security-guard/releases/download/v0.5.0/create-secrets.yaml
...
kubectl apply -f https://github.com/knative-extensions/security-guard/releases/download/v0.5.0/secured-helloworld.yaml

#add myapp - protected using a separate guard pod (non-recommended pattern)
kubectl apply -f https://github.com/knative-extensions/security-guard/releases/download/v0.5.0/secured-layered-myapp.yaml
