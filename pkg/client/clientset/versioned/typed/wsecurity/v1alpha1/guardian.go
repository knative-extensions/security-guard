...
import (
	...
	v1alpha1 "knative.dev/security-guard/pkg/apis/wsecurity/v1alpha1"
	scheme "knative.dev/security-guard/pkg/client/clientset/versioned/scheme"
)

// GuardiansGetter has a method to return a GuardianInterface.
// A group's client should implement this interface.
type GuardiansGetter interface {
	Guardians(namespace string) GuardianInterface
}
...
func newGuardians(c *WsecurityV1alpha1Client, namespace string) *guardians {
	return &guardians{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *guardians) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Guardian, err error) {
	result = &v1alpha1.Guardian{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("guardians").
		Name(name).
...
func (c *guardians) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.GuardianList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.GuardianList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("guardians").
...
func (c *guardians) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *guardians) Create(ctx context.Context, guardian *v1alpha1.Guardian, opts v1.CreateOptions) (result *v1alpha1.Guardian, err error) {
	result = &v1alpha1.Guardian{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("guardians").
...
func (c *guardians) Update(ctx context.Context, guardian *v1alpha1.Guardian, opts v1.UpdateOptions) (result *v1alpha1.Guardian, err error) {
	result = &v1alpha1.Guardian{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("guardians").
...
func (c *guardians) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *guardians) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *guardians) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Guardian, err error) {
	result = &v1alpha1.Guardian{}
